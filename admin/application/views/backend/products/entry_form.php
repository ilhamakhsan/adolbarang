        	...
        	<div class="row">
            	...
            	<div class="col-md-6">
					...
					<div class="form-group">
						...
						<?php echo form_input( array(
							'name' => 'stock',
							'value' => set_value( 'stock', show_data( @$stock ), false ),
							'class' => 'form-control form-control-sm',
							'placeholder' => "Please stock",
							'id' => 'stock'
						)); ?>
					...
					<div class="form-group">
						...
						<?php echo form_input( array(
							'name' => 'weigth',
							'value' => set_value( 'weigth', show_data( @$weigth ), false ),
							'class' => 'form-control form-control-sm',
							'placeholder' => "Please weigth",
							'id' => 'weigth'
						)); ?>
