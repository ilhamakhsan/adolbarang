<div class="table-responsive animated fadeInRight">
	<table class="table m-0 table-striped">
		<tr>
			...
			<th><?php echo get_msg('stock'); ?></th>
			<th><?php echo get_msg('weigth'); ?></th>
			...
			<tr>
				...
				<td><?php  
				 ...
				 <?php  
						...
						$unit_stock = $product->stock;

						$unit_stock = round($unit_stock, 2) ;
				 ...
				 <?php  
						...
						$unit_weigth = $product->weigth;

						$unit_weigth = round($unit_weigth, 2) ;
